...
class BookingDetailSummaryScreen extends StatefulWidget {
  final Map<String, dynamic> bookingDetails;

  const BookingDetailSummaryScreen({super.key, required this.bookingDetails});

  @override
  State<BookingDetailSummaryScreen> createState() => _BookingDetailSummaryScreenState();
}

class _BookingDetailSummaryScreenState extends State<BookingDetailSummaryScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final placeName = widget.bookingDetails['placeName'] ?? 'Unknown Place';
    final timeSlot = widget.bookingDetails['timeSlot'] ?? 'Not Selected';
    final price = widget.bookingDetails['price'] ?? 'N/A';
